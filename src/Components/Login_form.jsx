      ...
      <>
          <form className="flex flex-col mt-[2rem]">
              ...
              <div className="text-white bg-[#222a4a] rounded-md flex flex-row justify-between items-center mt-[0.2rem]">
                  ...
                  <button type="button" onClick={ typeHandler}><img src={type=="password" ? "/public/eye_closed.svg" : "/public/eye_open.svg" } className="text-white h-[2rem] w-[2rem] mr-[1rem]" alt="eye" /></button>
              </div>
              <div className="w-[100%] flex flex-row justify-end">
              <p className="text-[#3dacbf] text-[0.8rem]">Forgot Password</p>
              </div>
              <button onClick={ handleLogin}  className="w-[100%] bg-[#f3ff09] p-[0.5rem] font-bold rounded-md mt-[3rem]">Log in</button>
              ...
              <button type="button" className="flex flex-row justify-center items-center border-2 border-[#151244] p-[0.5rem] m-[1rem]" >
                  <img className="w-[2rem] pr-[0.5rem]" alt="google" src="/public/google.svg" />
